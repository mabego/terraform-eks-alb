...
# Secret string format similar to the autogenerated string when enabling Secrets Manager's provided multi-user
# password rotation: https://aws.amazon.com/blogs/database/multi-user-secrets-rotation-for-amazon-rds/
